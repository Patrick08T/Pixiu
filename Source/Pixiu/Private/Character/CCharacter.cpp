...
void ACCharacter::BindGASChangeDelegates()
{
	...
	{
		CAbilitySystemComponent->RegisterGameplayTagEvent(UCAbilitySystemStatics::GetDeathStatTag()).AddUObject(this, &ACCharacter::DeathTagUpdated);
	}
}
...
void ACCharacter::ConfigureOverHeadStatusWidget()
{
	...
	UOverHeadStatusGauge* OverHeadStatusGuage = Cast<UOverHeadStatusGauge>(OverHeadWidgetComponent->GetUserWidgetObject()); 
	if (OverHeadStatusGuage)
	{
		OverHeadStatusGuage->ConfigureWithASC(GetAbilitySystemComponent());
...
{
	SetRagdollEabled(true);
}

void ACCharacter::SetRagdollEabled(bool bIsEnabled)
{
	if (bIsEnabled)
	{
